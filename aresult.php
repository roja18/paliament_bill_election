...
<div class="all">
  ...
  <?php
   ...
   <div>
    ...
    <a href="pdf.php" class="btn"> <img src="image/pdf.PNG" width="10%" height="10%"> Download PDF</a>
    <a href="excel.php" class="btn"><img src="image/exel.PNG" width="10%" height="10%"> Download EXCEL</a><br>
  </div>
